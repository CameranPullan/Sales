...
- When writing new tests and verifying they work, do not run all tests in the suite.
- When fixing specific tests, test files and verifying they work, do not run all tests. You can run across all regions to verify no regression issues have been introduced.
...
- DO NOT run or modify any files in Audacia.Olympus.TestAutomation
